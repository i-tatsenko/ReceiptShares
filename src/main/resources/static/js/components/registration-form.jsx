...
export default class RegistrationForm extends React.Component {
    ...
    render() {
        ...
        return (
            <div id="reg-form-container" className="panel panel-primary">
                <div className="panel-heading">Register</div>
                <div className="panel-body">
                    <FormAlert message={this.state.alertMessage}/>
                    <form id='register-form'>
                        <div className="form-group">
                            <label>Name <input id="newUserName" className='form-control' type='text'
                                               placeholder='Your name'
                                               name='name'/></label>
                            <span className="help-block"/>
                        </div>
                        <div className="form-group">
                            <label>Email <input id="newUserEmail" className='form-control' type='email'
                                                placeholder='Email'
                                                name='email'/></label>
                            <span className="help-block"/>
                        </div>
                        ...
                        <div className="form-group">
                            <label>Password one more time <input id="newUserPasswordCheck" className='form-control'
                                                                 type='password'
                                                                 name='passwordCheck'
                                                                 placeholder="Password check"/></label>
                            <span className="help-block"/>
                        </div>
                        <div id="captcha"/>
